                                ...
                                <div class="ibox-body">
                                    ...
                                    <div class="col-lg-12 col-sm-12 form-group">
                                        <div class="col-md-12 mb-3 ">
                                            ...
                                            <a href="javascript:void(0);" class="add_button pull-right"
                                                title="add field"><img src="{{ asset('/images/add-icon.png') }}" /></a>
                                                        ...
                                                        <div class="row" style="margin-top:10px">
                                                            <div class="col-md-4">
                                                                <input type="text" name="from[]" value="{{ $range->from }}"
                                                                    placeholder="Range From" class="form-control"
                                                                    required>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <input type="text" name="to[]" value="{{ $range->to }}"
                                                                    placeholder="Range To" class="form-control" required>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <input type="text" name="prices[]"
                                                                    value="{{ $range->price }}" placeholder="Price"
                                                                    class="form-control" required>
                                                            </div>
                                                            <a href="javascript:void(0);" class="remove_button"
                                                                title="remove field"><img
                                                                    src="{{ asset('/images/remove-icon.png') }}" /></a>
                                ...
                                <div class="ibox-body">
                                    ...
                                    <div class="form-group">
                                        <input onclick="submitProductNow();" type="button" name="save" value="save"
                                            id="product_submit" class="btn btn-success">
