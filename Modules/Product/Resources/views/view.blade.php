                                ...
                                <div class="row" style="margin-top:10px">
                                    <div class="col-md-4">
                                        <input type="text" name="from[]" value="{{ $range->from }}"
                                            placeholder="Range From" class="form-control" disabled>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" name="to[]" value="{{ $range->to }}" placeholder="Range To"
                                            class="form-control" disabled>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="text" name="prices[]" value="{{ $range->price }}" placeholder="Price"
                                            class="form-control" disabled>
                                    </div>
        ...
        @foreach ($product->productimage as $image)
            <div class="m-r-10">
                <a href="{{ asset('/uploads/product/other-image/' . $image->images) }}" target="_adimage">
                    <img src="{{ asset('/uploads/product/other-image/' . $image->images) }}" alt="No Image"
