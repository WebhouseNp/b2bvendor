                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12 form-group">
                                            ...
                                            <input class="form-control" type="text"
                                                ...
                                                name="title" placeholder="Product Title Here" value="{{ old('title') }}">
...
@endsection
<?php $name = ['meta_description','description','highlight']; ?>
@push('push_scripts')
...
<script >
    $(document).ready(function(){
        ...
        if (productValue === 'standard_product') {
		  ...
		  success:function(response) {
              if(response.data){
                    $('#addvariantsection ').html(response.html);
                    
                    $('.inputTags').tagsinput('items');
                   var abcd =  $('.inputTags').tagsinput('items')
                   $.each(response.data, function(index,attribute_values){
                    //    console.log(index);
...
//     $.each(abcd, function(index,attribute_values){
//         arr.push([abcd[index]]);
//         console.log(arr);
        
//     });

// // console.log(abcd[0],abcd[1],abcd[2]);
// console.log(arr)

// console.log(fakeArrays);
...
//         // result.push(arr[i][j] + allCasesOfRest[i]);
//       }
//     }
//     return result;
//   }
...
console.log(getCombinations(arr,arr.length))
...
$(document).ready(function (e) {
    ...
    $('#product-create-form').submit(function(e) {
        ...
        e.preventDefault();
        var message = $('textarea#meta_description').val();
        var attributes =  $('.inputTags').tagsinput('items');
