                                ...
                                <div class="ibox-body">
                                    <div class="row">
                                        ...
                                        <input class="form-control" type="text"
                                            value="{{$vendor->category}}" name="name" placeholder="Name"
                                            disabled>
                                    </div> 
                                    <div class="col-lg-6 col-sm-12 form-group">
                                        <label>Shop Name</label>
                                        <input class="form-control" type="text"
                                            value="{{$vendor->shop_name}}" name="name" placeholder="Name"
                                            disabled>
                                    </div>
                                    <div class="col-lg-6 col-sm-12 form-group">
                                        <label>Email</label>
                                    ...
                                    <div class="col-lg-6 col-sm-12 form-group">
                                        ...
                                        <input class="form-control" type="text"
                                            value="{{$vendor->user->phone_num}}"
                                            name="phone" placeholder="Product phone Here" disabled>
                                        
                                    </div>
                                    <div class="col-lg-6 col-sm-12 form-group">
                                        <label>Representative Name</label>
                                        <input class="form-control" type="text" value="{{$vendor->representative_name}}"
                                    ...
                                    <div class="col-lg-6 col-sm-12 form-group">
                                        ...
                                        <input class="form-control" type="text"
                                            value="{{$vendor->name_on_card}}"
                                            name="city"  disabled>
                                    </div>
                                    <div class="col-lg-6 col-sm-12 form-group">
                                        <label>ID Card Number</label>
                                        <input class="form-control" type="text"
                                            value="{{$vendor->id_card_number}}"
                                            name="city"  disabled>
                                    </div>
                                    <div class="col-lg-6 col-sm-12 form-group">
                                        <label>category commission</label>
                                        <input class="form-control" type="text"
                                            value="{{$vendor->category_commission}}"
                                            name="city"  disabled>
                                    </div>
                                    <div class="col-lg-6 col-sm-12 form-group">
                                    ...
                                    <div class="col-lg-6 col-sm-12 form-group">
                                        ...
                                        <input class="form-control" type="text"
                                            value="{{$vendor->name_on_bank_acc}}"
                                            name="city"  disabled>
                                    </div>
                                    <div class="col-lg-6 col-sm-12 form-group">
                                        <label>paypal_id</label>
                                        <input class="form-control" type="text"
                                            value="{{$vendor->paypal_id}}"
                                            name="city"  disabled>
                                    </div>
                                    <div class="col-lg-6 col-sm-12 form-group">
                                        <label>store_location</label>
                                        <input class="form-control" type="text"
                                            value="{{$vendor->store_location}}"
                                            name="city"  disabled>
                                    </div>
                                    <div class="col-lg-6 col-sm-12 form-group">
                                        <label>store_contact_number</label>
                                        <input class="form-control" type="text"
                                            value="{{$vendor->store_contact_number}}"
                                            name="city"  disabled>
                                    </div>
                                    <div class="col-lg-6 col-sm-12 form-group">
                                        <label>status</label>
                                        <input class="form-control" type="text"
                                            value="{{$vendor->status==1?'Active':'Inactive'}}"
                                            name="city"  disabled>
                                    </div>
                                    <div class="col-lg-6 col-sm-12 form-group">
                                        ...
                                        <select name="vendor_type" id="vendor_status" class="form-control ">
                                            ...
                                            <option value="new" @if ($vendor->user->vendor_type=="new"){{"selected"}} @endif>New</option>
                                            <option value="approved" @if ($vendor->user->vendor_type=="approved"){{"selected"}} @endif>Approved</option>
                                            <option value="suspended" @if ($vendor->user->vendor_type=="suspended"){{"selected"}} @endif>Suspended/option>
    ...
    $(document).ready(function(){
       ...
       $('.delete').submit(function(e){
        ...
        return;
            ...
            var vendor_id = <?php echo $vendor->user->id ?>;
            $.ajax({
