...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">All Suspended users</div>
            <!-- <div>
                <a class="btn btn-info btn-md" href="">Add user</a>
            </div> -->
        </div>
            ...
            <table id="example-table" class="table table-striped table-bordered table-hover" cellspacing="0"
                ...
                @php($i=1)
                    ...
                    <tr>
                        ...
                        <td>{{ $data->vendor->category=="local_seller" ? 'Local Seller' : 'International Seller' }}</td>
                        <td><span class="btn btn-rounded btn-sm {{orderProccess($data->vendor_type) }} changeStatus"
                                ...
                                style="cursor: pointer;">Change Vendor Satus</span></td>
