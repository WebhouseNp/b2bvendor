...
<div class="page-content fade-in-up">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Contain Subcategory</th>
      <td><div id="does_contain_sub_category"></div></td>
    </tr>
	<tr>
		...
		var id = <?php echo $id; ?>;
          ...
          if(response.data.hot_category == '1'){
                    ...
                    if(response.data.does_contain_sub_category == '1'){
						document.getElementById('does_contain_sub_category').innerHTML = '<span class="label label-success">Yes</span>';
					}
					else if(response.data.does_contain_sub_category == '0'){
						document.getElementById('does_contain_sub_category').innerHTML = '<span class="label label-danger">No</span>';
					}
