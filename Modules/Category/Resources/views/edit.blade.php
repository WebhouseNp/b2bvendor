                    ...
                    <div class="ibox-body" style="">
                        <form id="category-update-form">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-1">
                                    <label class="ui-checkbox ui-checkbox-warning">
                                        <input type="checkbox" name="does_contain_sub_category"
                                            id="does_contain_sub_category">
                                        <span class="input-span"></span>Yes
                                    </label>
                                </div>
                                <label class="col-lg-8"><span class="alert-warning">*Remember:Don't tick on this
                            ...
                            <div class="form-group">
                                <input onclick="submitCategoryNow();" type="button" name="save" value="save"
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.data.hot_category == '1') {
                            document.getElementById('hot_category').checked = true;
                        } else {
                            document.getElementById('hot_category').checked = false;
                        }
