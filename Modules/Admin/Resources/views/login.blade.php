        ...
        <form>
            ...
            <div class="form-group">
                <div class="input-group-icon right">
                    ...
                    <input class="form-control " type="email" name="email" id="email" value="{{ old('email') }}" placeholder="Email" autocomplete="email">
                    @error('email')
            ...
            --}}
            <div class="form-group">
                <button class="btn btn-info btn-block" id="submitUser" type="button">Login</button>
            </div>
        </form>
    </div>
@endsection
